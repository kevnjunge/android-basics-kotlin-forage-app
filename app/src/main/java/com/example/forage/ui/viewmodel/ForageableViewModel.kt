...
private val forageableDao: ForageableDao
    ...
    fun addForageable(
        ...
        // launch coroutine and call the DAO method to add a Forageable to the database within it
    ...
    fun updateForageable(
        ...
        viewModelScope.launch(Dispatchers.IO) {
            // call DAO method to update a forageable to the database
    ...
    fun deleteForageable(forageable: Forageable) {
        viewModelScope.launch(Dispatchers.IO) {
            // call the DAO method to delete a forageable to the database
