...
class ForageableListFragment : Fragment() {
    ...
    /**
     * creation of the view model to take an instance of
     * Forageable ViewModelFactory. The factory should take an instance of the Database retrieved
     *from BaseApplication
     */
    private val viewModel: ForageableViewModel by activityViewModels(){
        ForageableViewModelFactory(
            (activity?.application as BaseApplication).database.foregiableDao()
        )
    }
